...
const AnnshLanding = () => {
  ...
  return (
    <div className="bg-[#f5f5dc] min-h-screen">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <ul className="space-y-3 mb-8 text-[#f5f5dc]">
                ...
                <li className="flex items-center"><Check className="text-green-400 mr-2" size={16} />Kitchen Dashboard</li>
                ...
                <li className="flex items-center"><Check className="text-green-400 mr-2" size={16} />Sales analytics</li>
                <li className="flex items-center"><Check className="text-green-400 mr-2" size={16} />Staff management</li>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 bg-gradient-to-br from-[#4b2e2e]/5 to-[#4b2e2e]/10">
